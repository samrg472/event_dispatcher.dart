...
class EventDispatcher {
   ...
   */
  bool register(EventHandlerFunction handler, {EventFilter filter: _defaultFilter, int priority, bool always: false}) {
    if (priority == null) {
      priority = defaultPriority;
    }
...
class _EventHandler {
  ...
  _EventHandler(this.function, this.filter, this.priority, [this.object, this.always = false]);
